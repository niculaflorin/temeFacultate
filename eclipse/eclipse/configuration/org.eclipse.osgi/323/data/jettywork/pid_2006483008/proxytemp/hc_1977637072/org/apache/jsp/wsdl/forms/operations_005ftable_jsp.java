...
public final class operations_005ftable_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 *******************************************************************************/
   ...
   twistImageName.append(tableContainerId);   
      ...
      out.print(wsdlPerspective.getMessage("FORM_LABEL_OPERATIONS"));
      out.write("</strong></td>\n");
      out.write("  </tr>\n");
      out.write("</table>\n");
      out.write("\n");
   ...
   for (int i=0;i<operationNodes.size();i++)
   {
     ...
     WSDLOperationElement wsdlOperationElement = (WSDLOperationElement)operationNode.getTreeElement();
      ...
      out.print(response.encodeURL(controller.getPathWithContext(SelectWSDLNavigatorNodeAction.getActionLink(operationNode.getNodeId(),false))));
      out.write('"');
      out.write('>');
      out.print(wsdlOperationElement.getOperation().getName());
      out.write("</a></td>\n");
