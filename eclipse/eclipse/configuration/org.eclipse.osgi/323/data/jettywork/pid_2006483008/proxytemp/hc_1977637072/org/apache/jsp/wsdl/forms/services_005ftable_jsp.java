...
public final class services_005ftable_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 *******************************************************************************/
   ...
   twistImageName.append(tableContainerId);   
      ...
      out.print(wsdlPerspective.getMessage("FORM_LABEL_SERVICES"));
      out.write("</strong></td>\n");
      out.write("  </tr>\n");
      out.write("</table>\n");
      out.write("\n");
   ...
   for (int i=0;i<serviceNodes.size();i++)
   {
     ...
     WSDLServiceElement wsdlServiceElement = (WSDLServiceElement)serviceNode.getTreeElement();
      ...
      out.print(response.encodeURL(controller.getPathWithContext(SelectWSDLNavigatorNodeAction.getActionLink(serviceNode.getNodeId(),false))));
      out.write('"');
      out.write('>');
      out.print(wsdlServiceElement.getService().getQName().getLocalPart());
      out.write("</a></td>\n");
