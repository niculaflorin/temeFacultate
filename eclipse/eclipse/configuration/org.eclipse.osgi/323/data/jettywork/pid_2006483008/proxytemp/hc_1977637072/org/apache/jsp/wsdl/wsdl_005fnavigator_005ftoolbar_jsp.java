...
public final class wsdl_005fnavigator_005ftoolbar_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 *******************************************************************************/
   ...
   WSDLPerspective wsdlPerspective = controller.getWSDLPerspective();
      ...
      out.write("  <title>");
      out.print(wsdlPerspective.getMessage("FRAME_TITLE_NAVIGATOR_TOOLBAR"));
      out.write("</title>\n");
      out.write("  <link rel=\"stylesheet\" type=\"text/css\" href=\"");
      out.print(response.encodeURL(controller.getPathWithContext("css/toolbar.css")));
      out.write("\">\n");
      org.apache.jasper.runtime.JspRuntimeLibrary.include(request, response, "/wsdl/scripts/wsdlframesets.jsp", out, true);
      out.write("  \n");
  ...
  formAction.append("wsdl/actions/ResizeWSDLFramesActionJSP.jsp");
   ...
   formFrameName.append(WSDLFrameNames.WSDL_NAVIGATOR_CONTAINER);
      ...
      out.write('\n');
      org.apache.jasper.runtime.JspRuntimeLibrary.include(request, response, "/wsdl/forms/ProcessWSDLFramesetsForm.jsp", out, true);
      out.write("\n");
   ...
   String altClear = controller.getMessage("ALT_CLEAR");
      ...
      out.print(response.encodeURL(controller.getPathWithContext("wsdl/actions/RefreshWSDLActionJSP.jsp")));
      out.write("\" target=\"");
      ...
      out.write("\"></a></td>\n");
      out.write("        <td valign=\"middle\" align=\"center\" width=25 height=25><a href=\"");
      out.print(response.encodeURL(controller.getPathWithContext("wsdl/actions/ClearWSDLActionJSP.jsp")));
      out.write("\" target=\"");
      out.print(FrameNames.PERSPECTIVE_WORKAREA);
      out.write("\"><img class=\"normal\" src=\"");
