...
public final class wsdl_005fstatus_005ftoolbar_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 *******************************************************************************/
  ...
  formAction.append("wsdl/actions/ResizeWSDLFramesActionJSP.jsp");
   ...
   formFrameName.append(WSDLFrameNames.WSDL_STATUS_CONTAINER);
      ...
      out.print(response.encodeURL(controller.getPathWithContext("images/status.gif")));
   ...
   if (doubleClickColumnTitle == null)
     doubleClickColumnTitle = controller.getMessage("ALT_DOUBLE_CLICK_TO_MAXIMIZE");
      ...
      out.print(controller.getMessage("ALT_STATUS"));
      out.write("</td>\n");
