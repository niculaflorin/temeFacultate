...
public final class wsdl_005fstatus_005fcontent_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 *******************************************************************************/
   ...
   wsdlPerspective.setStatusContentType(WSDLPerspective.STATUS_CONTENT_DEFAULT);
      ...
      out.write("      <td>\n");
      out.write("        <pre>\n");
      out.print(HTMLUtils.charactersToHTMLEntitiesStrict(wsdlPerspective.getMessageQueue().getMessagesFromList()));
      out.write("\n");
      out.write("        </pre>\n");
      out.write("      </td>\n");
      out.write("    </tr>\n");
