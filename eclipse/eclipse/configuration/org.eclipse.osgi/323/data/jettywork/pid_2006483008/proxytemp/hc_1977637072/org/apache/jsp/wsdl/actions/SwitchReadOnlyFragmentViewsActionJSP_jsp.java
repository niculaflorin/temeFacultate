...
public final class SwitchReadOnlyFragmentViewsActionJSP_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if (wsdlPerspective.getStatusContentType() == WSDLPerspective.STATUS_CONTENT_RESULT_FORM)
  ...
  wsdlPerspective.setStatusContentType(WSDLPerspective.STATUS_CONTENT_RESULT_FORM);
      ...
      out.print(response.encodeURL(controller.getPathWithContext("wsdl/wsdl_result_content.jsp")));
      out.write("\";\n");
      out.write("</script>\n");
      out.write("\n");
